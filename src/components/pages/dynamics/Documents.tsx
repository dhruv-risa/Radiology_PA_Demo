  ...
  return (
    <div className="pb-24">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t px-6 py-4 flex justify-end gap-3 z-20">
        ...
        {!isMarkedComplete && (
          <>
            {paStatus && (['Query', 'Clinical Missing', 'Supporting Imaging Missing', 'Invalid Dx Code', 'Eligibility Failed'].includes(paStatus.authStatus) || paStatus.AutomationWorkflow === 'Blocked') && (
              <button
