...
export default function Authorization() {
  ...
  const getSubmissionStatus = () => {
    ...
    if (['Clinical Missing', 'Supporting Imaging Missing', 'Invalid Dx Code'].includes(paStatus.authStatus)) {
  ...
  return (
    <div className="pb-24">
      <div className="max-w-4xl mx-auto">
        ...
        {paStatus.authStatus !== 'NAR' && (paStatus.authStatus !== 'Auth Required' || paStatus.paFiled) && (
        <div className="bg-white border rounded-lg p-4 mb-4">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t px-6 py-4 flex justify-end gap-3 z-20">
        ...
        {!isMarkedComplete && (
          <>
            {(['Queries', 'Clinical Missing', 'Supporting Imaging Missing', 'Invalid Dx Code', 'Eligibility Failed'].includes(paStatus.authStatus) || paStatus.automationStatus === 'Blocked') && (
              <button
